...
def try_methods_and_functions():
    ...
    #
    ####################################################################
    shamal = rg.SimpleTurtle()
    shamal.pen = rg.Pen('blue', 5)

    shamal.backward(150)

    shamal.speed = 1
    draw_many_squares(shamal, 2, 100, 30)

    shamal.speed = 5
    shamal.pen.color = 'red'
    draw_many_squares(shamal, 10, 50, 15)

    shamal.speed = 100
    shamal.pen.thickness = 35
    draw_many_squares(shamal, 8, 300, 60)

    shamal.pen = rg.Pen('black', 3)

    shamal.backward(200)

    shamal.draw_circle(30)

    shamal.draw_square(50)
